import {DateArray, IInstanceDate, MbDate} from './abstract';

export class JDate extends MbDate implements IInstanceDate {
    /// Functions
     ...
     */
    getMonthShortNames() {
        return ['Far', 'Ord', 'Kho', 'Tir', 'Mor', 'Sha', 'Meh', 'Aba', 'Aza', 'Day', 'Bah', 'Sfa'];
    }
